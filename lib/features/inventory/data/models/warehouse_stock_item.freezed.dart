...
mixin _$WarehouseStockItem {
 ...
 String get productId; String get productName; String get sku; int get quantity; double get costPrice; int get minStock;
...
@override
int get hashCode => Object.hash(runtimeType,productId,productName,sku,quantity,costPrice,minStock);

@override
String toString() {
  return 'WarehouseStockItem(productId: $productId, productName: $productName, sku: $sku, quantity: $quantity, costPrice: $costPrice, minStock: $minStock)';
}
...
@useResult
$Res call({
 String productId, String productName, String sku, int quantity, double costPrice, int minStock
});
...
/// Create a copy of WarehouseStockItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productId = null,Object? productName = null,Object? sku = null,Object? quantity = null,Object? costPrice = null,Object? minStock = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String productId,  String productName,  String sku,  int quantity,  double costPrice,  int minStock)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WarehouseStockItem() when $default != null:
return $default(_that.productId,_that.productName,_that.sku,_that.quantity,_that.costPrice,_that.minStock);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String productId,  String productName,  String sku,  int quantity,  double costPrice,  int minStock)  $default,) {final _that = this;
switch (_that) {
case _WarehouseStockItem():
return $default(_that.productId,_that.productName,_that.sku,_that.quantity,_that.costPrice,_that.minStock);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String productId,  String productName,  String sku,  int quantity,  double costPrice,  int minStock)?  $default,) {final _that = this;
switch (_that) {
case _WarehouseStockItem() when $default != null:
return $default(_that.productId,_that.productName,_that.sku,_that.quantity,_that.costPrice,_that.minStock);case _:
  return null;
...
class _WarehouseStockItem extends WarehouseStockItem {
  const _WarehouseStockItem({required this.productId, required this.productName, required this.sku, required this.quantity, required this.costPrice, required this.minStock}): super._();
...
/// Create a copy of WarehouseStockItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productId = null,Object? productName = null,Object? sku = null,Object? quantity = null,Object? costPrice = null,Object? minStock = null,}) {
