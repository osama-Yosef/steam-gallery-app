...
bool techAccountTxnIncreasesDue(TechAccountTxnType t) =>
    t != TechAccountTxnType.supplyDebit;

@freezed
abstract class TechnicianAccountTransaction
    with _$TechnicianAccountTransaction {
  ...
  factory TechnicianAccountTransaction.fromRow(Map<String, dynamic> row) =>
      TechnicianAccountTransaction(
        id: row['id'] as String,
