...
// a past order's delivery details.
 String? get deliveryRecipientName; String? get deliveryPhone; String? get deliveryBuilding; String? get deliveryFloor; String? get deliveryApartment; String? get deliveryLandmark; double? get deliveryLatitude; double? get deliveryLongitude; String? get deliveryCityId; String? get deliveryServiceAreaId; double? get shippingFee; ShippingFeeStatus get shippingFeeStatus; String? get shippingFeeRejectionReason; String? get notes; String? get cancelledReason; DateTime get createdAt;
...
as double?,deliveryCityId: freezed == deliveryCityId ? _self.deliveryCityId : deliveryCityId // ignore: cast_nullable_to_non_nullable
as String?,deliveryServiceAreaId: freezed == deliveryServiceAreaId ? _self.deliveryServiceAreaId : deliveryServiceAreaId // ignore: cast_nullable_to_non_nullable
as String?,shippingFee: freezed == shippingFee ? _self.shippingFee : shippingFee // ignore: cast_nullable_to_non_nullable
as double?,shippingFeeStatus: null == shippingFeeStatus ? _self.shippingFeeStatus : shippingFeeStatus // ignore: cast_nullable_to_non_nullable
as ShippingFeeStatus,shippingFeeRejectionReason: freezed == shippingFeeRejectionReason ? _self.shippingFeeRejectionReason : shippingFeeRejectionReason // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.orderNumber,_that.customerId,_that.status,_that.subtotal,_that.discount,_that.total,_that.paidAmount,_that.paymentStatus,_that.deliveryAddress,_that.deliveryRecipientName,_that.deliveryPhone,_that.deliveryBuilding,_that.deliveryFloor,_that.deliveryApartment,_that.deliveryLandmark,_that.deliveryLatitude,_that.deliveryLongitude,_that.deliveryCityId,_that.deliveryServiceAreaId,_that.shippingFee,_that.shippingFeeStatus,_that.shippingFeeRejectionReason,_that.notes,_that.cancelledReason,_that.createdAt);case _:
  return orElse();
...
class _Order extends Order {
  const _Order({required this.id, required this.orderNumber, required this.customerId, required this.status, required this.subtotal, required this.discount, required this.total, required this.paidAmount, required this.paymentStatus, this.deliveryAddress, this.deliveryRecipientName, this.deliveryPhone, this.deliveryBuilding, this.deliveryFloor, this.deliveryApartment, this.deliveryLandmark, this.deliveryLatitude, this.deliveryLongitude, this.deliveryCityId, this.deliveryServiceAreaId, this.shippingFee, required this.shippingFeeStatus, this.shippingFeeRejectionReason, this.notes, this.cancelledReason, required this.createdAt}): super._();
...
@override final  String? deliveryCityId;
@override final  String? deliveryServiceAreaId;
@override final  double? shippingFee;
@override final  ShippingFeeStatus shippingFeeStatus;
@override final  String? shippingFeeRejectionReason;
