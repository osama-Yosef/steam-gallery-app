...
mixin _$Product {
 ...
 String get id; String get sku; String? get barcode; String? get categoryId; String get name; String? get description; Map<String, String> get specs; double get costPrice; double get sellingPrice; int get minStock; bool get isActive; bool get isService; DateTime get createdAt; String? get primaryImageUrl;
...
@override
int get hashCode => Object.hash(runtimeType,id,sku,barcode,categoryId,name,description,const DeepCollectionEquality().hash(specs),costPrice,sellingPrice,minStock,isActive,isService,createdAt,primaryImageUrl);

@override
String toString() {
  return 'Product(id: $id, sku: $sku, barcode: $barcode, categoryId: $categoryId, name: $name, description: $description, specs: $specs, costPrice: $costPrice, sellingPrice: $sellingPrice, minStock: $minStock, isActive: $isActive, isService: $isService, createdAt: $createdAt, primaryImageUrl: $primaryImageUrl)';
}
...
@useResult
$Res call({
 String id, String sku, String? barcode, String? categoryId, String name, String? description, Map<String, String> specs, double costPrice, double sellingPrice, int minStock, bool isActive, bool isService, DateTime createdAt, String? primaryImageUrl
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String sku,  String? barcode,  String? categoryId,  String name,  String? description,  Map<String, String> specs,  double costPrice,  double sellingPrice,  int minStock,  bool isActive,  bool isService,  DateTime createdAt,  String? primaryImageUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.sku,_that.barcode,_that.categoryId,_that.name,_that.description,_that.specs,_that.costPrice,_that.sellingPrice,_that.minStock,_that.isActive,_that.isService,_that.createdAt,_that.primaryImageUrl);case _:
  return orElse();
...
class _Product implements Product {
  const _Product({required this.id, required this.sku, this.barcode, this.categoryId, required this.name, this.description, required final  Map<String, String> specs, required this.costPrice, required this.sellingPrice, required this.minStock, required this.isActive, this.isService = false, required this.createdAt, this.primaryImageUrl}): _specs = specs;
...
@override
int get hashCode => Object.hash(runtimeType,id,sku,barcode,categoryId,name,description,const DeepCollectionEquality().hash(_specs),costPrice,sellingPrice,minStock,isActive,isService,createdAt,primaryImageUrl);
