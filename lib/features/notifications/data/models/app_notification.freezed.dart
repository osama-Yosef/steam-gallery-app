...
class _AppNotification implements AppNotification {
  const _AppNotification({required this.id, required this.type, required this.title, this.body, required final  Map<String, dynamic> data, required this.isRead, required this.createdAt}): _data = data;
