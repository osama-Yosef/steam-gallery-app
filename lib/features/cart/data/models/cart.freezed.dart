...
mixin _$CartLine {
 ...
 String get productId; String get name; String? get sku; String? get imageUrl; int get quantity; double get unitPrice; double get priceSeen; bool get priceChanged; double get lineTotal; bool get isActive; bool get isAvailable;
...
@override
int get hashCode => Object.hash(runtimeType,productId,name,sku,imageUrl,quantity,unitPrice,priceSeen,priceChanged,lineTotal,isActive,isAvailable);

@override
String toString() {
  return 'CartLine(productId: $productId, name: $name, sku: $sku, imageUrl: $imageUrl, quantity: $quantity, unitPrice: $unitPrice, priceSeen: $priceSeen, priceChanged: $priceChanged, lineTotal: $lineTotal, isActive: $isActive, isAvailable: $isAvailable)';
}
...
@useResult
$Res call({
 String productId, String name, String? sku, String? imageUrl, int quantity, double unitPrice, double priceSeen, bool priceChanged, double lineTotal, bool isActive, bool isAvailable
});
...
/// Create a copy of CartLine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productId = null,Object? name = null,Object? sku = freezed,Object? imageUrl = freezed,Object? quantity = null,Object? unitPrice = null,Object? priceSeen = null,Object? priceChanged = null,Object? lineTotal = null,Object? isActive = null,Object? isAvailable = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String productId,  String name,  String? sku,  String? imageUrl,  int quantity,  double unitPrice,  double priceSeen,  bool priceChanged,  double lineTotal,  bool isActive,  bool isAvailable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartLine() when $default != null:
return $default(_that.productId,_that.name,_that.sku,_that.imageUrl,_that.quantity,_that.unitPrice,_that.priceSeen,_that.priceChanged,_that.lineTotal,_that.isActive,_that.isAvailable);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String productId,  String name,  String? sku,  String? imageUrl,  int quantity,  double unitPrice,  double priceSeen,  bool priceChanged,  double lineTotal,  bool isActive,  bool isAvailable)  $default,) {final _that = this;
switch (_that) {
case _CartLine():
return $default(_that.productId,_that.name,_that.sku,_that.imageUrl,_that.quantity,_that.unitPrice,_that.priceSeen,_that.priceChanged,_that.lineTotal,_that.isActive,_that.isAvailable);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String productId,  String name,  String? sku,  String? imageUrl,  int quantity,  double unitPrice,  double priceSeen,  bool priceChanged,  double lineTotal,  bool isActive,  bool isAvailable)?  $default,) {final _that = this;
switch (_that) {
case _CartLine() when $default != null:
return $default(_that.productId,_that.name,_that.sku,_that.imageUrl,_that.quantity,_that.unitPrice,_that.priceSeen,_that.priceChanged,_that.lineTotal,_that.isActive,_that.isAvailable);case _:
  return null;
...
class _CartLine extends CartLine {
  const _CartLine({required this.productId, required this.name, this.sku, this.imageUrl, required this.quantity, required this.unitPrice, required this.priceSeen, required this.priceChanged, required this.lineTotal, required this.isActive, required this.isAvailable}): super._();
...
/// Create a copy of CartLine
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productId = null,Object? name = null,Object? sku = freezed,Object? imageUrl = freezed,Object? quantity = null,Object? unitPrice = null,Object? priceSeen = null,Object? priceChanged = null,Object? lineTotal = null,Object? isActive = null,Object? isAvailable = null,}) {
